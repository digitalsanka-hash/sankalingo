# Hari 8 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-tiga-tenses.png`

**Caption:**

```
Kamu tidak perlu hafal dua belas tenses untuk mulai bicara.
...
**Berkas:** `slot2-tenses-yang-cukup-01.png` … `-06.png` (unggah berurutan)

**Caption:**

```
Kalau kamu pernah hafal tabel dua belas tenses lalu tetap bingung waktu bicara — masalahnya bukan hafalanmu.
...
**Berkas:** `slot3-relate-grammar-nazi.png`

**Caption:**

```
"Yang penting orang ngerti kan?"
...
**Berkas:** `slot4-jual-latihan.png`

**Caption:**

```
Aplikasi bahasa umumnya bilang: salah, coba lagi.
