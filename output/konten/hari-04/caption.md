# Hari 4 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-arab-huruf.png`
...
**Berkas:** `slot2-arab-dari-kanan-01.png` … `-05.png` (unggah berurutan)

**Caption:**

```
Kalau kamu pernah merasa huruf Arab mustahil dipelajari orang dewasa — geser dulu.
...
**Berkas:** `slot3-koreksi-jerman-v2.png`
...
```
9.052 entri kamus. Sembilan bahasa. Semuanya bisa dibuka tanpa internet.
