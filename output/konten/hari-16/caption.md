# Hari 16 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-jepang-toko.png`

**Caption:**

```
Kalau kamu ke Jepang bulan depan dan cuma sempat hafal empat kalimat — hafal empat ini.
...
**Berkas:** `slot2-jepang-sopan-turis-01.png` … `-06.png` (unggah berurutan)

**Caption:**

```
Sepuluh kalimat yang benar-benar dipakai di Jepang — bukan yang ada di buku pelajaran.
...
**Berkas:** `slot3-koreksi-sumimasen.png`

**Caption:**

```
すみません bukan cuma "maaf".
...
**Berkas:** `slot4-jual-suara.png`

**Caption:**

```
Masalah belajar bahasa dari teks: kamu hafal tulisannya, tapi tidak tahu bunyinya.
