# Hari 22 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-lowongan-tersaring.png`

**Caption:**

```
Yang paling menyakitkan dari penolakan lamaran kerja bukan ditolak setelah wawancara.
...
**Berkas:** `slot2-kerja-jarak-jauh-01.png` … `-06.png` (unggah berurutan)

**Caption:**

```
Kerja dari rumah di Indonesia, dibayar perusahaan luar negeri, dalam mata uang mereka. Ini sudah biasa — bukan mimpi.
...
**Berkas:** `slot3-koreksi-sorry-english.png`
...
**Berkas:** `slot4-jual-satu-kali.png`

**Caption:**

```
Belajar bahasa itu tidak pernah lurus. Ada bulan yang rajin, ada bulan yang hilang sama sekali.
