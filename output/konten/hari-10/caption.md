# Hari 10 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-korea-haeyo.png`
...
**Berkas:** `slot2-korea-tingkat-bahasa-01.png` … `-05.png` (unggah berurutan)

**Caption:**

```
Kalau kamu belajar Korea dari drama, ada satu hal yang perlu diluruskan sebelum kamu bicara dengan orang Korea sungguhan.
...
**Berkas:** `slot3-koreksi-modal-can.png`

**Caption:**

```
"She can swims." atau "I can to swim."
...
**Berkas:** `slot4-jual-sinkron.png`

**Caption:**

```
Belajar di HP waktu di angkot, lanjut di laptop waktu di kos — tanpa mengulang dari nol.
