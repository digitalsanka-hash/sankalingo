# Hari 1 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-hiragana-baris-a.png`
...
**Berkas:** `slot2-baca-hiragana-5-menit-01.png` … `-05.png` (unggah berurutan)

**Caption:**

```
Lima menit. Sepuluh huruf. Tiga kata Jepang yang bisa kamu baca sendiri.
...
**Berkas:** `slot3-koreksi-two-book.png`
...
**Berkas:** `slot4-jual-hari1.png`

**Caption:**

```
Kenapa sembilan bahasa dalam satu aplikasi, bukan satu bahasa yang "fokus"?
