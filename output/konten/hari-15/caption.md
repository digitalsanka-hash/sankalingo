# Hari 15 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-kata-rapat.png`

**Caption:**

```
Rapat bahasa Inggris yang bikin panik biasanya bukan karena kosakatamu kurang. Karena kamu tidak punya kalimat untuk menyelamatkan diri.
...
**Berkas:** `slot2-inggris-kerja-nyata-01.png` … `-06.png` (unggah berurutan)

**Caption:**

```
Kosakata yang diajarkan di sekolah: apple, banana, strawberry.
...
**Berkas:** `slot3-relate-diam-di-rapat.png`

**Caption:**

```
Orang yang diam di rapat bahasa Inggris sering dikira tidak punya pendapat.
...
**Berkas:** `slot4-jual-cefr.png`

**Caption:**

```
Masalah belajar dari internet bukan kualitas materinya. Banyak yang bagus.
