# Hari 23 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-jepang-kerja.png`

**Caption:**

```
Kalau targetmu kerja di Jepang, JLPT N2 cuma tiket masuk — bukan kesiapan.
...
```
#kerjadijepang #jlpt #belajarbahasajepang #hiragana #katakana #jlpt #bahasajepang #nihongo #belajarjepang #anime
```
...
**Berkas:** `slot2-negara-tujuan-01.png` … `-06.png` (unggah berurutan)

**Caption:**

```
Kalau tujuanmu bekerja atau menetap di luar negeri, pilih bahasanya berdasarkan tujuan — bukan berdasarkan mana yang terdengar paling keren.
...
```
#kerjadiluarnegeri #jlpt #topik #lowongankerja #karier #beasiswa #freshgraduate #tipskarir #kerjaremote #upgradeskill
```
...
```
"Umur 35, masih sempat belajar bahasa baru?"
...
**Berkas:** `slot4-jual-9-bahasa.png`
