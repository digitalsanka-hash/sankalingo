# Hari 30 — SankaLingo GO

## Slot 1 · Gambar tunggal

**Berkas:** `slot1-hari-terakhir.png`

**Caption:**

```
Hari terakhir rangkaian tiga puluh hari.
...
**Berkas:** `slot2-penutup-tawaran-01.png` … `-06.png` (unggah berurutan)

**Caption:**

```
Penutup rangkaian tiga puluh hari.
...
**Berkas:** `slot3-jujur-bukan-untuk-siapa.png`

**Caption:**

```
Sebelum kamu memutuskan, ini yang BUKAN kamu dapat:
...
**Berkas:** `slot4-penutup-terakhir.png`

**Caption:**

```
Bagian paling menarik dari menguasai bahasa asing bukan yang kamu rencanakan.
