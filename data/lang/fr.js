...
scripts: [
{
  ...
  chars: [
    F('é','é','Accent aigu — miring ke KANAN. Dibaca "e" tertutup seperti pada "sate".',
      ['M26 62 C26 50 44 46 50 56 C54 64 40 70 26 68 C26 80 42 86 56 80','M46 34 L60 24'],'e aigu'),
    F('è','è','Accent grave — miring ke KIRI. Dibaca "e" terbuka seperti pada "bebek".',
      ['M26 62 C26 50 44 46 50 56 C54 64 40 70 26 68 C26 80 42 86 56 80','M46 24 L60 34'],'e grave'),
    ...
    F('à','à','Menandai beda makna: a (punya) vs à (ke).',
      ['M30 60 C34 50 52 50 54 62 L54 84','M54 66 C40 62 26 68 28 78 C30 86 48 88 54 80','M46 24 L60 34'],'a grave'),
    ...
    F('ù','ù','Hanya muncul pada kata où (di mana), membedakannya dari ou (atau).',
      ['M28 50 L28 72 C28 82 44 86 52 76','M54 50 L54 84','M44 22 L58 32'],'u grave'),
