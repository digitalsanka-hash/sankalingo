...
scripts: [
{
  ...
  chars: [
    ...
    S('á','á','Aksen menandai suku kata bertekanan, bukan mengubah bunyi.',
      ['M30 60 C34 50 52 50 54 62 L54 84','M54 66 C40 62 26 68 28 78 C30 86 48 88 54 80','M44 34 L58 24'],'a dengan tilde'),
    S('é','é','Sama: hanya menandai tekanan.',
      ['M26 62 C26 50 44 46 50 56 C54 64 40 70 26 68 C26 80 42 86 56 80','M44 34 L58 24'],'e dengan tilde'),
    S('í','í','Titik pada i hilang bila diberi aksen.',
      ['M50 48 L50 84','M42 34 L56 24'],'i dengan tilde'),
    S('ó','ó','Menandai tekanan pada o.',
      ['M50 48 C36 48 30 58 30 68 C30 78 38 86 50 86 C62 86 70 78 70 68 C70 58 64 48 50 48','M44 34 L58 24'],'o dengan tilde'),
    S('ú','ú','Menandai tekanan pada u.',
      ['M28 48 L28 72 C28 82 44 86 52 76','M54 48 L54 84','M44 34 L58 24'],'u dengan tilde'),
